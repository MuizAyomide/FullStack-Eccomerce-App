...
const onSubmitHandler = async () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} action="" className='flex flex-col item-center w-[90%] sm:max-w-96 m-auto mt-14 mb-14 gap-4 text-gray-800'>
      ...
      <button className='bg-black text-white mt-4 font-light px-8 py-2 cursor-pointer'>{currentState === 'login' ? 'Sign In' : 'Sign Up'}</button>
